...
public class FluidAssemblerCategory implements IRecipeCategory<FluidAssemblerRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(Klux.MODID, "fluid_assembler");
    public static final ResourceLocation TEXTURE = new ResourceLocation(Klux.MODID,
            "textures/jei/gui_fluid_assembler.png");
    public static final ResourceLocation ARROW = new ResourceLocation(Klux.MODID,
            "textures/jei/arrow_2.png");

    public static final RecipeType<FluidAssemblerRecipe> FLUID_ASSEMBLER_TYPE =
            new RecipeType<>(UID, FluidAssemblerRecipe.class);
    ...
    private FluidAssemblerRecipe currentRecipe;

    public FluidAssemblerCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 93);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.FLUID_ASSEMBLER.get()));
    ...
    @Override
    public RecipeType<FluidAssemblerRecipe> getRecipeType() {
        return FLUID_ASSEMBLER_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.klux.fluid_assembler");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, FluidAssemblerRecipe recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(FluidAssemblerRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {

        arrow.draw(guiGraphics, 93, 38);

        guiGraphics.pose().pushPose();
        guiGraphics.pose().translate(0, 0, 300);
        meter.draw(guiGraphics, 33, 16);
        ...
        Component timeText = Component.translatable("jei.klux.fluid_assembler.time", String.format("%.2f", seconds));
