...
public class JEIKluxPlugin implements IModPlugin {
    ...
    public void registerCategories(IRecipeCategoryRegistration registration) {
        ...
        registration.addRecipeCategories(new GemDuplicatorCategory(registration.getJeiHelpers().getGuiHelper()));
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<GemDuplicatorRecipe> gemDuplicatorRecipes = recipeManager.getAllRecipesFor(GemDuplicatorRecipe.Type.INSTANCE);
        ...
        registration.addRecipes(GemDuplicatorCategory.GEM_DUPLICATOR_TYPE, gemDuplicatorRecipes);
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(new ItemStack(ModBlocks.GEM_DUPLICATOR.get()), GemDuplicatorCategory.GEM_DUPLICATOR_TYPE);
