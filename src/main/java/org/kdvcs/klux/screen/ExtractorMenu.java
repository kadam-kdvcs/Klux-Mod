...
import org.kdvcs.klux.block.entity.ExtractorBlockEntity;
...
public class ExtractorMenu extends AbstractContainerMenu {
    ...
    public ExtractorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 47, 36));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 109, 36));
        });
