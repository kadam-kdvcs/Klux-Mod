...
/*
 *
 * FROM TERRABLENDER (EXAMPLE REGION)
 *
 *
 */
...
public class ModOverworldRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper)
    {
        ...
        // Overlap Vanilla's parameters with our own for our CELESTE biome.
        ...
        new ParameterUtils.ParameterPointListBuilder()
                ...
                .erosion(ParameterUtils.Erosion.EROSION_6)  //  6 REFERS TO A FLAT AREA
                .depth(ParameterUtils.Depth.SURFACE, ParameterUtils.Depth.FLOOR)
                .weirdness(ParameterUtils.Weirdness.MID_SLICE_NORMAL_ASCENDING, ParameterUtils.Weirdness.MID_SLICE_NORMAL_DESCENDING)
                .build().forEach(point -> builder.add(point, ModBiomes.CELESTE));
